...
def get_qchem_aimd_data(file_iterator, plot_type, num_header_lines, num_columns, col_types):
...
def plot_qchem_aimd_data(column_titles, data, plotfilename, plot_title):
...
def plot_qchem_aimd_data_1stcol_time(column_titles, data, plotfilename, plot_title):
...
def main(args):
    ...
    if plot_type == "Cost":
        ...
        header_lines, data = get_qchem_aimd_data(file_iterator, plot_type, num_header_lines, num_columns, col_types)
        plotfilename = plot_type + ".pdf"
        plot_qchem_aimd_data(column_titles, data, plotfilename, plot_title=plot_type)
