...
def parse_line(line, max_mo_index):
    ''''''
    split = line.split()
    ...
    for i, contrib in enumerate(contribs):
        entry = (idx_atom, element, orbital_name, contrib)
        try:
...
if __name__ == '__main__':
    ...
    pretty_print_orbitals(filtered_mos)
