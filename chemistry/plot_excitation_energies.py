...
def getargs():
    ...
    parser.add_argument(
        "--actually-plot",
        action="store_true",
        help="""Do we actually want to make plots and save them to file(s)?""",
    )
...
def main(args):
    ...
    matches_orca_cis = ("CIS-EXCITED STATES", "CIS EXCITED STATES")
    ...
    for inputfilename in args.inputfile:
        ...
        try:
            ...
            if type(job) == cclib.parser.orcaparser.ORCA:
                ...
                excitation_energies = [
                    convertor(energy_es - energy_gs, "hartree", "eV") for energy_es in energies_es
                ]
